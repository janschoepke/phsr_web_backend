...
class MailingTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Headline', 'Content', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'headline', 'content', 'description', ),
        self::TYPE_COLNAME       => array(MailingTableMap::COL_ID, MailingTableMap::COL_NAME, MailingTableMap::COL_HEADLINE, MailingTableMap::COL_CONTENT, MailingTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'headline', 'content', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Headline' => 2, 'Content' => 3, 'Description' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'headline' => 2, 'content' => 3, 'description' => 4, ),
        self::TYPE_COLNAME       => array(MailingTableMap::COL_ID => 0, MailingTableMap::COL_NAME => 1, MailingTableMap::COL_HEADLINE => 2, MailingTableMap::COL_CONTENT => 3, MailingTableMap::COL_DESCRIPTION => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'headline' => 2, 'content' => 3, 'description' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
