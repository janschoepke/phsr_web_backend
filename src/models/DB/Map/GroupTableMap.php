...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DB.Map.GroupTableMap';
     ...
     */
    const OM_CLASS = '\\DB\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DB.Group';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID, GroupTableMap::COL_NAME, GroupTableMap::COL_DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID => 0, GroupTableMap::COL_NAME => 1, GroupTableMap::COL_DESCRIPTION => 2, ),
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Group) { // it's a model object
