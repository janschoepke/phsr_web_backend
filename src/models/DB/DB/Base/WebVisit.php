...
/**
 * Base class that represents a row from the 'WebVisits' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class WebVisit implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\DB\\Map\\WebVisitTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\WebVisit object.
     */
    ...
    /**
     * Compares this with another <code>WebVisit</code> instance.  If
     * <code>obj</code> is an instance of <code>WebVisit</code>, delegates to
     * <code>equals(WebVisit)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|WebVisit The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_ID] = true;
        }
    ...
    public function setMailingId($v)
    {
        ...
        if ($this->mailing_id !== $v) {
            $this->mailing_id = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_MAILING_ID] = true;
        }
    ...
    public function setOs($v)
    {
        ...
        if ($this->os !== $v) {
            $this->os = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_OS] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[WebVisitTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_URL] = true;
        }
    ...
    public function setVictimId($v)
    {
        ...
        if ($this->victim_id !== $v) {
            $this->victim_id = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_VICTIM_ID] = true;
        }
    ...
    public function setUnknownId($v)
    {
        ...
        if ($this->unknown_id !== $v) {
            $this->unknown_id = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_UNKNOWN_ID] = true;
        }
    ...
    public function setBrowser($v)
    {
        ...
        if ($this->browser !== $v) {
            $this->browser = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_BROWSER] = true;
        }
    ...
    public function setIp($v)
    {
        ...
        if ($this->ip !== $v) {
            $this->ip = $v;
            $this->modifiedColumns[WebVisitTableMap::COL_IP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WebVisitTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWebVisitQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see WebVisit::setDeleted()
     * @see WebVisit::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWebVisitQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WebVisitTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WebVisitTableMap::COL_ID)) {
        ...
        if ($this->isColumnModified(WebVisitTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_URL)) {
            $modifiedColumns[':p' . $index++]  = 'url';
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_VICTIM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'victim_id';
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_UNKNOWN_ID)) {
            $modifiedColumns[':p' . $index++]  = 'unknown_id';
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_BROWSER)) {
    ...
    {
        $pos = WebVisitTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['WebVisit'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WebVisit'][$this->hashCode()] = true;
        $keys = WebVisitTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DB\WebVisit The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WebVisitTableMap::COL_ID)) {
            $criteria->add(WebVisitTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_MAILING_ID)) {
        ...
        if ($this->isColumnModified(WebVisitTableMap::COL_TIMESTAMP)) {
            $criteria->add(WebVisitTableMap::COL_TIMESTAMP, $this->timestamp);
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_URL)) {
            $criteria->add(WebVisitTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_VICTIM_ID)) {
            $criteria->add(WebVisitTableMap::COL_VICTIM_ID, $this->victim_id);
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_UNKNOWN_ID)) {
            $criteria->add(WebVisitTableMap::COL_UNKNOWN_ID, $this->unknown_id);
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_BROWSER)) {
            $criteria->add(WebVisitTableMap::COL_BROWSER, $this->browser);
        }
        if ($this->isColumnModified(WebVisitTableMap::COL_IP)) {
    ...
    {
        $criteria = ChildWebVisitQuery::create();
        $criteria->add(WebVisitTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DB\WebVisit (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\WebVisit Clone of current object.
     * @throws PropelException
     */
    ...
    public function getMailing(ConnectionInterface $con = null)
    {
        if ($this->aMailing === null && ($this->mailing_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMailing->addWebVisits($this);
             */
        }
    ...
    public function getVictim(ConnectionInterface $con = null)
    {
        if ($this->aVictim === null && ($this->victim_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVictim->addWebVisits($this);
             */
        }
    ...
    {
        if (null !== $this->aMailing) {
            $this->aMailing->removeWebVisit($this);
        }
        if (null !== $this->aVictim) {
    ...
    {
        return (string) $this->exportTo(WebVisitTableMap::DEFAULT_STRING_FORMAT);
    }
