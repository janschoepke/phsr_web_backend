...
/**
 * Base class that represents a row from the 'Victim_Mailings' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class VictimMailings implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\DB\\Map\\VictimMailingsTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\VictimMailings object.
     */
    ...
    /**
     * Compares this with another <code>VictimMailings</code> instance.  If
     * <code>obj</code> is an instance of <code>VictimMailings</code>, delegates to
     * <code>equals(VictimMailings)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|VictimMailings The current object, for fluid interface
     */
    ...
    public function setVictimId($v)
    {
        ...
        if ($this->victim_id !== $v) {
            $this->victim_id = $v;
            $this->modifiedColumns[VictimMailingsTableMap::COL_VICTIM_ID] = true;
        }
    ...
    public function setMailingId($v)
    {
        ...
        if ($this->mailing_id !== $v) {
            $this->mailing_id = $v;
            $this->modifiedColumns[VictimMailingsTableMap::COL_MAILING_ID] = true;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[VictimMailingsTableMap::COL_TIMESTAMP] = true;
            }
    ...
    /**
     * Set the value of [opened] column.
     *
     * @param int $v new value
     * @return $this|\DB\VictimMailings The current object (for fluent API support)
     */
    public function setOpened($v)
    {
        ...
        if ($this->opened !== $v) {
            $this->opened = $v;
            $this->modifiedColumns[VictimMailingsTableMap::COL_OPENED] = true;
        }
    ...
    /**
     * Set the value of [clicked] column.
     *
     * @param int $v new value
     * @return $this|\DB\VictimMailings The current object (for fluent API support)
     */
    public function setClicked($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->clicked !== $v) {
            $this->clicked = $v;
            $this->modifiedColumns[VictimMailingsTableMap::COL_CLICKED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VictimMailingsTableMap::translateFieldName('VictimId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->victim_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VictimMailingsTableMap::translateFieldName('MailingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mailing_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VictimMailingsTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->timestamp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VictimMailingsTableMap::translateFieldName('Opened', TableMap::TYPE_PHPNAME, $indexType)];
            $this->opened = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VictimMailingsTableMap::translateFieldName('Clicked', TableMap::TYPE_PHPNAME, $indexType)];
            $this->clicked = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VictimMailingsTableMap::translateFieldName('Customparam', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = VictimMailingsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildVictimMailingsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see VictimMailings::setDeleted()
     * @see VictimMailings::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVictimMailingsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VictimMailingsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VictimMailingsTableMap::COL_VICTIM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'victim_id';
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_MAILING_ID)) {
            $modifiedColumns[':p' . $index++]  = 'mailing_id';
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_OPENED)) {
        ...
        $sql = sprintf(
            'INSERT INTO Victim_Mailings (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'timestamp':
                        ...
                        break;
                    case 'opened':
                        $stmt->bindValue($identifier, $this->opened, PDO::PARAM_INT);
                        break;
                    case 'clicked':
    ...
    {
        $pos = VictimMailingsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['VictimMailings'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VictimMailings'][$this->hashCode()] = true;
        $keys = VictimMailingsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getVictimId(),
            $keys[1] => $this->getMailingId(),
            $keys[2] => $this->getTimestamp(),
            $keys[3] => $this->getOpened(),
            $keys[4] => $this->getClicked(),
            $keys[5] => $this->getCustomparam(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setOpened($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setClicked($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setCustomparam($arr[$keys[5]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\DB\VictimMailings The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VictimMailingsTableMap::COL_VICTIM_ID)) {
            $criteria->add(VictimMailingsTableMap::COL_VICTIM_ID, $this->victim_id);
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_MAILING_ID)) {
            $criteria->add(VictimMailingsTableMap::COL_MAILING_ID, $this->mailing_id);
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_TIMESTAMP)) {
            $criteria->add(VictimMailingsTableMap::COL_TIMESTAMP, $this->timestamp);
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_OPENED)) {
            $criteria->add(VictimMailingsTableMap::COL_OPENED, $this->opened);
        }
        if ($this->isColumnModified(VictimMailingsTableMap::COL_CLICKED)) {
    ...
    {
        $criteria = ChildVictimMailingsQuery::create();
        $criteria->add(VictimMailingsTableMap::COL_VICTIM_ID, $this->victim_id);
        $criteria->add(VictimMailingsTableMap::COL_MAILING_ID, $this->mailing_id);
    ...
    {
        $validPk = null !== $this->getVictimId() &&
            null !== $this->getMailingId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation Victim_Mailings_fk_be7293 to table Victims
        if ($this->aVictim && $hash = spl_object_hash($this->aVictim)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation Victim_Mailings_fk_c928cd to table Mailings
        if ($this->aMailing && $hash = spl_object_hash($this->aMailing)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        $pks = array();
        $pks[0] = $this->getVictimId();
        $pks[1] = $this->getMailingId();
    ...
    {
        $this->setVictimId($keys[0]);
        $this->setMailingId($keys[1]);
    }
    ...
    {
        return (null === $this->getVictimId()) && (null === $this->getMailingId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DB\VictimMailings (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\VictimMailings Clone of current object.
     * @throws PropelException
     */
    ...
    public function getVictim(ConnectionInterface $con = null)
    {
        if ($this->aVictim === null && ($this->victim_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aVictim->addVictimMailingss($this);
             */
        }
    ...
    public function getMailing(ConnectionInterface $con = null)
    {
        if ($this->aMailing === null && ($this->mailing_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMailing->addVictimMailingss($this);
             */
        }
    ...
    {
        if (null !== $this->aVictim) {
            $this->aVictim->removeVictimMailings($this);
        }
        if (null !== $this->aMailing) {
    ...
    {
        return (string) $this->exportTo(VictimMailingsTableMap::DEFAULT_STRING_FORMAT);
    }
