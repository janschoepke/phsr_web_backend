...
abstract class MailingQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, headline, content, description FROM Mailings WHERE id = :p0';
        try {
     ...
     * @return $this|ChildMailingQuery The current query, for fluid interface
     */
    public function joinVictimMailings($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useVictimMailingsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
     ...
     * using the Victim_Mailings table as cross reference
     *
