...
module.exports = function(grunt) {
  ...
  grunt.registerTask('build', ['concat:coffee','coffee','uglify:app']);
  ...
  grunt.registerTask('development', ['copy:bootstrap','build','lib','clean:development','mkdir:clean']);

  // Setup environment for production
  grunt.registerTask('production', ['copy:bootstrap','build','lib:production','clean:production','mkdir:clean']);
